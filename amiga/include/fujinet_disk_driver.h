...
#define FUJINET_DD_ADF_BLOCK_COUNT  1760UL
#define FUJINET_HD_ADF_BLOCK_COUNT  3520UL
/* Kept for backwards compatibility; prefer FUJINET_DD_ADF_BLOCK_COUNT. */
#define FUJINET_ADF_BLOCK_COUNT     FUJINET_DD_ADF_BLOCK_COUNT
#define FUJINET_ADF_BYTE_SIZE \
    (FUJINET_DISK_BLOCK_SIZE * FUJINET_DD_ADF_BLOCK_COUNT)
